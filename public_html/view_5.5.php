...
$result = pg_exec($link, "SELECT poi.category AS tab1, COUNT(user_id) AS tab2 FROM poi,check_in WHERE poi_id=poi.id GROUP BY poi.category HAVING COUNT(user_id) > 1000 ORDER BY COUNT(user_id) DESC;")
