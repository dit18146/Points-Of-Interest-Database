...
$result = pg_exec($link, "SELECT category AS tab1, city.name AS tab2, city.state AS tab3, city.country AS tab4, COUNT(user_id) AS tab5
                            ...
                            AND city.longitude>$name
                            AND city.longitude<$name2
                            AND city.latitude>$name3
                            AND city.latitude<$name4
                            GROUP BY category, city.name, city.state, city.country, user_id
...
<tr>
        ...
        <th>Πολιτεία</th>
        <th>Χώρα</th>
        <th>Αριθμός Επισκέψεων στο συγκεκριμένο poi</th>
	</tr>
	<?php
