...
$result = pg_exec($link, "SELECT name,surname,dob,gender,followers_num, (COUNT(user1_id)+COUNT(user2_id))/2 AS tab
                            FROM users, friends 
                            WHERE id=user2_id
                            OR id=user1_id 
